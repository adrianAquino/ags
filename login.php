              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Digite seu email e senha para fazer login</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Ainda não tem uma conta? <a href="registro.php">Criar uma Conta</a></p>
                    </div>
                  </form>
