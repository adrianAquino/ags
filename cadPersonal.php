...
if (isset($_POST['salvar'])) {
    ...
    //3 Preparar a SQL
    $sql = "insert into personal (nome, email, senha, sexo, dataNascimento, cref, cpf, cnpj, telefone, cep, endereco, numero, bairro, cidade, estado, observacao) values ('$nome', '$email', '$senha', '$sexo', '$dataNascimento','$cref', '$cpf' '$cnpj','$telefone', '$cep', '$endereco', '$numero', '$bairro','$cidade', '$estado', '$observacao')";
