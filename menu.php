    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li>
          ...
          <li>
            <a href="components-alerts.html">
              <i class="bi bi-circle"></i><span>Modalidades de Treino</span>
            </a>
          </li>
          <li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-layout-text-window-reverse"></i><span>Meus Planos de Treino</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
